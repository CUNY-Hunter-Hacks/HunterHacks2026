...
function App() {
  ...
  const faqs = [
    {
      ...
      answer: "HunterHacks is a 24-48 hour Hackathon where beginner or experienced hackers can come together to ideate, design, and build projects over one exciting weekend. It is brought together by the CS Departments and CS USG clubs, and completely free of charge to attend."
    },
    {
      question: "Is HunterHacks in-person?",
      answer: "HunterHacks is a hybrid event with both virtual and in-person components. However, Sunday is mandatory in-person for judging and the closing ceremony."
    },
    {
    ...
    },
    {
      ...
      answer: "We are accepting application through April 10, 2026. Click on 'Apply Now' up top to get started!"
    },
    {
      question: "How many people in a team?",
      answer: "Teams can be 2-4 people. You can sign up with a team or join solo and find others during our team formation activities after the Opening Ceremony. We'll have icebreakers, team matching sessions, and mentors available to help you find teammates before hacking begins."
    },
    {
      question: "Do I have to submit a project?",
      answer: "Submitting a project is highly encouraged. You can attend workshops, network, and enjoy the experience without building something. Only submitted projects are eligible for prizes by the submission deadline."
    },
    {
      question: "Will there be food and swag?",
      answer: "Absolutely! Expect meals, snacks, energy drinks, and exclusive merch. Raffles and prizes will also be available for participants who stick around through the weekend! Check the schedule for location and times."
    },
    {
      question: "Will there be workshops?",
      answer: "Yes! Workshops run throughout the weekend, covering both technical and non-technical topics like coding, design (Figma), resume-building, and navigating workplace scenarios. Check the schedule for location and times."
    },
    {
      question: "I'm interested in sponsoring. How do I get in touch?",
      answer: "Thank you so much for your interest! Please contact our team at cunyhunterhacks@gmail.com. Please also see our prospectus under the sponsors tab for more information."
    }
  ]
  ...
  const handleMouseMove = (e) => {
    ...
    for (const borough of boroughs) {
      ...
      if (canvasX >= 0 && canvasX < canvasData.canvas.width &&
        canvasY >= 0 && canvasY < canvasData.canvas.height) {
          ...
          <div className="countdown-container">
            <div className="countdown-unit">
              <div className="countdown-value">
                {String(countdown.days).padStart(2, '0').split('').map((digit, idx) => (
            ...
            <div className="countdown-unit">
              <div className="countdown-value">
                {String(countdown.hours).padStart(2, '0').split('').map((digit, idx) => (
                  <span key={idx} className="digit">{digit}</span>
                ))}
              </div>
            ...
            <div className="countdown-unit">
              <div className="countdown-value">
                {String(countdown.minutes).padStart(2, '0').split('').map((digit, idx) => (
                  <span key={idx} className="digit">{digit}</span>
                ))}
              </div>
            ...
            <div className="countdown-unit">
              <div className="countdown-value">
                {String(countdown.seconds).padStart(2, '0').split('').map((digit, idx) => (
                  <span key={idx} className="digit">{digit}</span>
                ))}
              </div>
        ...
        <section className="sponsors-section" id="sponsors">
          <div className="sponsors-container">
            ...
            <div className="sponsors-content">
              ...
              <p className="sponsor-text">Want a custom metrocard? Become a sponsor! <br></br>Email us at <a href="mailto:cunyhunterhacks@gmail.com" className="sponsor-email">cunyhunterhacks@gmail.com</a>
                <br></br>
                <br></br>
                Please take a look at our latest prospectus <a href="/prospectus.pdf" target="_blank" rel="noopener noreferrer" className="sponsor-link"> here</a>!
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="footer-container">
            <div className="footer-content">
              <div className="footer-social">
                <a href="https://www.instagram.com/cunyhunterhacks/" target="_blank" rel="noopener noreferrer" className="social-link">
                ...
                <a href="https://www.linkedin.com/company/cunyhunterhacks/" target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                  </svg>
                </a>
                <a href="https://discord.gg/b5M2UCQB" target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="footer-credits">
                ...
                <p className="footer-designer">Designed and coded by Kelly Lin @ GWC</p>
              </div>
            </div>
          </div>
        </footer>
