  ...
  const faqs = [
    {
      ...
      answer: "HunterHacks is a 48~ hour Hackathon where beginner or experienced hackers can come together to ideate, design, and build projects over one exciting weekend. It is brought together by the CS Departments and CS USG clubs, and completely free of charge to attend."
    },
    {
    ...
    },
    {
      ...
      answer: "Unfortunately, we have met our capacity for this semester's hackathon, but we encourage you to still apply in the case that we put you on our waitlist."
    },
    {
      ...
      <section className="sponsors-section" id="sponsors">
        <div className="sponsors-container">
          ...
          <div className="sponsors-content">
            ...
            <p className="sponsor-text">Want a custom metrocard? Become a sponsor! <br></br>Email us at <a href="mailto:cunyhunterhacks@gmail.com" className="sponsor-email">cunyhunterhacks@gmail.com</a></p>
          </div>
        </div>
      </section>
